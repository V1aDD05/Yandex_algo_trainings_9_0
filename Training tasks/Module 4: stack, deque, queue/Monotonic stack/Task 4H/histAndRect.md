...
![image](https://assets.contest.yandex.net/testsys/statement-file?hash=eyJhbGciOiJkaXIiLCJlbmMiOiJBMjU2R0NNIn0..gl2rTpjy7hlu67kp.EVjU4cqFl6gHt-lTinIjsl7F4qiacXHKg_Bp3DWIXk2HwTidVmJrkUtMuQTtgyk0WUx90h-gLyJYeXMuGGQLDR8bdcaT-A.HbTqenczHt-Bi3mEYTxEpA)
...
В первой строке входного файла записано число N ( 0 < N ≤ 1 06 0<N≤106) — количество прямоугольников гистограммы. Затем следует N целых чисел h 1 , . . . , h n h1​,...,hn​, где 0 ≤ h i ≤ 1 09 0≤hi​≤109. Эти числа обозначают высоты прямоугольников гистограммы слева направо. Ширина каждого прямоугольника равна 1
