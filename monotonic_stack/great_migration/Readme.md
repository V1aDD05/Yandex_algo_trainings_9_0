...
[Задача 4.G в Тренировках по алгоритмам 9.0](https://new.contest.yandex.ru/contests/89531/problems?id=30404%2F2023_01_18%2Fm3PAau25IW)
...
В первой строке дано одно число `N` (`2≤N≤10^5`) — количество городов в Лайнландии. Во второй строке дано `N` чисел `ai`​ (`0≤ai​≤10^9`) — средняя цена проживания в городах с нулевого по `(N - 1)`-й соответственно.
