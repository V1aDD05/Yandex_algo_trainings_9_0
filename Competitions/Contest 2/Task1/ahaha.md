...
В первой строке находится одно натуральное число n n ( 1 ≤ n ≤ 1 05 1≤n≤105) — длина строки с ответом девушки.

Во второй строке находится строка из строчных латинских букв длины n n — ответ девушки.
