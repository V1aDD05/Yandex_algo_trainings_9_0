# 95. Сумма в прямоугольнике

[Дополнительная задача с CodeRun](https://coderun.yandex.ru/problem/rectangle-sum)
