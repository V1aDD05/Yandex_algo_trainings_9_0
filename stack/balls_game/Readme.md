...
[Задача 12.1 в Тренировках по алгоритмам 9.0](https://new.contest.yandex.ru/contests/89544/problems?id=23867%2F2026_03_01%2FYSwACHCPFO)
...
Обработка данных и удаление шариков выполняется непосредственно в main процессе чтения данных.

Это позволяет упростить код для такой логики (простой, линейной), так как обработка сильно связана со вводом.
